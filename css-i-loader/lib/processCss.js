...
var scopeValue = require('./scopeValue');
...
module.exports = function processCss(inputSource, inputMap, options, callback) {
    ...
    const isClassModule = options.query.classModule;

    var parserOptions = {
        root: root,
        mode: isClassModule ? 'local' : options.mode,
        url: query.url !== false,
    ...
    var exports = {};
    if (isClassModule) {
        const id = customGetLocalIdent(options.loaderContext, localIdentName, options.from, {
        ...
        if (id) {
            exports = id;
            plugins.push(scopeValue.default(id));
        }
    ...
    pipeline.process(inputSource, {
        ...
        from: "/css-i-loader!" + options.from,
        to: options.to,
        ...
        callback(null, {
            ...
            exports: isClassModule ? exports : parserOptions.exports,
        ...
        if (err.name === 'CssSyntaxError') {
            var wrappedError = new CSSLoaderError(
                'Syntax Error',
                err.reason,
                err.line != null && err.column != null ? { line: err.line, column: err.column } :
                null,
                err.input.source
            );
